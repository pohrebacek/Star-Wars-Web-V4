<?php
// source: /home/rizzek/Documents/GitHub/Star-Wars-Web-V4/Star-Wars-Web-V4/config/common.neon
// source: /home/rizzek/Documents/GitHub/Star-Wars-Web-V4/Star-Wars-Web-V4/config/services.neon
// source: /home/rizzek/Documents/GitHub/Star-Wars-Web-V4/Star-Wars-Web-V4/config/local.neon
// source: array
...
class Container_c6f5f4b657 extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'ArrayAccess' => [2 => ['01', 'application.1', 'application.2', 'application.3', 'application.4', 'application.6']],
		'Nette\Application\Routers\RouteList' => [['01']],
		'App\Model\Era\EraFacade' => [['02']],
		'App\Model\Era\EraMapper' => [['03']],
		'App\Model\Base\BaseRepository' => [['04', '07']],
		'App\Model\Era\ErasRepository' => [['04']],
		'App\Model\Media\MediaFacade' => [['05']],
		'App\Model\Media\MediaMapper' => [['06']],
		'App\Model\Media\MediaRepository' => [['07']],
		'App\Presentation\Base\BasePresenter' => [2 => ['application.1', 'application.3', 'application.4']],
		'Nette\Application\UI\Presenter' => [
			2 => ['application.1', 'application.2', 'application.3', 'application.4', 'application.6'],
		],
		...
		'App\Presentation\Timeline\TimelinePresenter' => [2 => ['application.1']],
		'App\Presentation\Home\HomePresenter' => [2 => ['application.2']],
		'App\Presentation\Media\MediaPresenter' => [2 => ['application.3']],
		'App\Presentation\Error\Error5xx\Error5xxPresenter' => [2 => ['application.5']],
		'App\Presentation\Error\Error4xx\Error4xxPresenter' => [2 => ['application.6']],
	...
	public function createService02(): App\Model\Era\EraFacade
	{
		return new App\Model\Era\EraFacade($this->getService('03'), $this->getService('04'));
	}


	public function createService03(): App\Model\Era\EraMapper
	{
		return new App\Model\Era\EraMapper;
	}


	public function createService04(): App\Model\Era\ErasRepository
	{
		return new App\Model\Era\ErasRepository($this->getService('database.default.explorer'));
	}


	public function createService05(): App\Model\Media\MediaFacade
	{
		return new App\Model\Media\MediaFacade($this->getService('07'), $this->getService('06'));
	}


	public function createService06(): App\Model\Media\MediaMapper
	{
		return new App\Model\Media\MediaMapper;
	}


	public function createService07(): App\Model\Media\MediaRepository
	{
		return new App\Model\Media\MediaRepository($this->getService('database.default.explorer'));
	}


	public function createServiceApplication__1(): App\Presentation\Timeline\TimelinePresenter
	{
		$service = new App\Presentation\Timeline\TimelinePresenter($this->getService('05'));
	...
	public function createServiceApplication__2(): App\Presentation\Home\HomePresenter
	{
	...
	public function createServiceApplication__3(): App\Presentation\Media\MediaPresenter
	{
		$service = new App\Presentation\Media\MediaPresenter(
			$this->getService('02'),
			$this->getService('07'),
			$this->getService('04'),
			$this->getService('05'),
	...
	public function createServiceApplication__4(): App\Presentation\Base\BasePresenter
	{
		$service = new App\Presentation\Base\BasePresenter;
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__5(): App\Presentation\Error\Error5xx\Error5xxPresenter
	{
		return new App\Presentation\Error\Error5xx\Error5xxPresenter($this->getService('tracy.logger'));
	}


	public function createServiceApplication__6(): App\Presentation\Error\Error4xx\Error4xxPresenter
	{
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'/home/rizzek/Documents/GitHub/Star-Wars-Web-V4/Star-Wars-Web-V4/temp/cache/nette.application/touch',
		));
	...
	{
		return new Nette\Caching\Storages\FileStorage('/home/rizzek/Documents/GitHub/Star-Wars-Web-V4/Star-Wars-Web-V4/temp/cache');
	}
	...
	public function createServiceDatabase__default__connection(): Nette\Database\Connection
	{
		$service = new Nette\Database\Connection(
			'mysql:host=127.0.0.1;port=3306;dbname=star_wars_web_v4',
			/*sensitive{*/'root'/*}*/,
			/*sensitive{*/'123456'/*}*/,
			[],
		);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_c6f5f4b657 $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/home/rizzek/Documents/GitHub/Star-Wars-Web-V4/Star-Wars-Web-V4/temp/cache/latte');
